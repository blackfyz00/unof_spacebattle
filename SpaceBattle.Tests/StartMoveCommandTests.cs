...
public class StartMoveCommandTest
{
    ...
    public void TestWithoutError()
    {
        ...
        var StartMoveCommand = new StartMoveCommand(_macrocommand.Object, _isender.Object, _gameobject.Object);

        //act
        StartMoveCommand.Execute();

        //post
        _gameobject.VerifySet(m => m["Movement"] = _macrocommand.Object, Times.Once);
